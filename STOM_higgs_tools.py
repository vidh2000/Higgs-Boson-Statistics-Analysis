...
def get_B_chi(vals, mass_range, nbins, A, lamb):
    ...
    return "Background chi=",chi, "Background reduced chi =",chi/float(nbins-2) # B has 2 parameters.
...
def get_SB_chi(vals, mass_range, nbins, A, lamb, mu, sig, signal_amp):
    ...
    return "Signal chi=",chi, "Signal reduced chi =",chi/float(nbins-5) # SB has 5 parameters.
